a={
            ...
            /* config.module.rule('vue') */
            {
                ...
                use: [
                    /* config.module.rule('vue').use('cache-loader') */
                    {
                        loader: 'cache-loader',
                        options: {
                            cacheDirectory: 'D:\\project\\mine\\node_modules\\.cache\\vue-loader',
                            cacheIdentifier: '0e64129f'
                        }
                    },
                ...
                use: [
                    /* config.module.rule('eslint').use('eslint-loader') */
                    {
                        ...
                        options: {
                            ...
                            cache: true,
                            cacheIdentifier: '034cc2a6',
                            emitWarning: true,
                            emitError: false,
                            eslintPath: 'D:\\project\\mine\\node_modules\\eslint\\lib\\api.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin(
            {
                ...
                template: 'D:\\project\\mine\\public\\index.html',
                cdn: {
                    css: [
        ...
        new CopyWebpackPlugin(
            [
                {
                    from: 'D:\\project\\mine\\public',
                    to: 'D:\\project\\mine\\dist',
                    toType: 'dir',
                    ignore: [
                        '.DS_Store'
                    ]
