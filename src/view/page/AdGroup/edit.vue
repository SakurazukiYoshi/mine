<template>
    <div class="component-container">
        ...
        <div class="top-box">
            <div >
                <p><sn-icon type="ad-plan" color="#C5CCD4" size="24" class="open-icon"/></p>
                <p class="t-box-title">广告计划</p>
                <p class="t-box-sub">预算设置、广告排期</p>
            </div>
            <div class="loading-spot spot-active">
                <span class="spot"></span>
                <span class="spot"></span>
                <span class="spot"></span>
            </div>
            <div class="active">
                <p><sn-icon type="ad-group" color="#2198F0" size="24" class="open-icon"/></p>
            ...
            <template v-if="true">
                ...
                <sn-form-item label="年龄"
                    ...
                    <div class="flex">
                        <sn-select :width="110"
                                   placeholder="选择年龄">
                            <sn-option label="14" value="14"></sn-option>
                            <sn-option label="15" value="15"></sn-option>
                            <sn-option label="16" value="16"></sn-option>
                            <sn-option label="17" value="17"></sn-option>
                        </sn-select>
                        <span class="w6">-</span>
                        <sn-select :width="110"
                                   placeholder="选择年龄">
...
<script>
    import {FormItem,Form,Button,Textarea,Input,Checkbox,CheckboxGroup,Icon,Radio,RadioGroup,Poptip,Select,Option,areaSelect} from "_c"
