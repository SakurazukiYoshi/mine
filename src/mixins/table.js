...
/*            let query=Object.assign({},{
        ...
        //状态切换前的确定弹窗
        beforeSwitchChange(){
/*            return api_common.handleWaring({success:()=>true,fail:()=>false,text:'确认切换？'});*/
        },
        //编辑成功后的回调
        submitSuccess(){
            this.editForm=false;
        ...
        getTableHeight(){
            if(this.$refs.table&&this.$refs.tableContent){
                ...
                let pageHeight=parseInt(getStyle(this.$refs.tableContent.$el, 'padding-bottom'))+parseInt(getStyle(this.$refs.tableContent.$el, 'margin-bottom'))+10;  //page的高度
